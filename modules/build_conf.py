...
class generic_conf:
    ...
    package_list_file = "/home/ubuntu/miniTux/New_Project/autotest-build-tool/input_file" 	           	 # This file will contain the package name to be build
...
class custom_conf:
    ...
    build_tag = [ 'mcp8_3-ppc64le','mcp8_1-x86_64' ]                            # for specific build tag mentioned like mcp8_1-ppc64le
    input_file = ""                                                             # This file will contain the packges to be build for autotest
    build_supporting_tags = ['mcp8_3-ppc64le','mcp8_3-x86_64','mcp8_3-ia32','mcp8_3-s390x','mcp8_1-s390x','mcp8_1-x86_64','mcp8_1-ia32','mcp8_1-ppc','mcp8_1-ppcnf','mcp8_1-ppc64le','mcp8_0-x86_64','mcp8_0-ia32','mcp8_0-ppc','mcp8_0-ppcnf','mcp8_0-s390x','ALL']
